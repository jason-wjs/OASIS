...
@MotionsSceneCfgFactory.register("table_white_basket")
class TableWhiteBasketSceneCfg(InteractiveSceneCfg, RandomizableSceneMixin): # inherit from the interactive scene configuration class
    """object table scene configuration class
    defines a complete scene containing robot, object, table, etc.
    """

    # 机器人初始位姿 (MuJoCo [w,x,y,z] quaternion)
    robot_init_pos = (-2.46, -1.5, 0.76)
    ...
    cup = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[-2.5, -2.0, 0.75],
                                                  rot=[0, 1.0, 0, 0]),
        spawn=UsdFileCfg(
