...
@MotionsSceneCfgFactory.register("wipe_under_table")
class WipeUnderTableSceneCfg(InteractiveSceneCfg, RandomizableSceneMixin):
    """坐地擦桌底场景：房间 + 桌子 + 焊到右手的海绵。"""

    # 机器人初始位姿 (MuJoCo [w,x,y,z] quaternion)
    robot_init_pos = (-2.46, -1.6, 0.76)
    robot_init_rot = (0.7071, 0, 0, -0.7071)

    # 1. 房间墙体 —— 与其它 scene 完全一致
    ...
    sponge = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[-2.6, -1.95, 0.8],
